...
from bluelog.blueprints.data import data_bp
...
def register_commands(app):
    ...
    @app.cli.command()
    @click.option('--category', default=1, help='Quantity of categories, default is 10.')
    @click.option('--post', default=5, help='Quantity of posts, default is 50.')
    @click.option('--comment', default=50, help='Quantity of comments, default is 500.')
